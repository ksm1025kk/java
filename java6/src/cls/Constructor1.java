...
public class Constructor1 {
	public static void main(String[] args) {
		// 클래스의 생성자
		// 생성자 : 사람이 초기값을 입력하지 않으면 실행이 안되게끔 해버리는 문법(반드시 초기값을 입력하게끔 해놓은 문법)
		// 생성자는 메서드, class의 이름과 동일한 이름의 메서드
...
class MyClass9Test{
	public void test(MyClass9 mc) {
		...
		else if(mc.getHeight() < 15) {
			System.out.println(mc.getName() + "은(는) 키 미달. 탑승분가");
		}
		else {
