...
public class Mydatetime {
	...
	static String str2 = "static 정적 멤버변수"; 	// 객체화 안하고 사용가능 (변수 생성시점 이후에만)
	public static void main(String[] args) {
		...
		GetInstance get = GetInstance.getInstance();		// GetInstance. : static으로 올려놔서 막 접근 가능
...
class MyTime{
	// 자바코드로 현재시간을 가져오는법  : Calendar, Date, SimpleDateFormat, String
	// 멤버변수
	private String str;
